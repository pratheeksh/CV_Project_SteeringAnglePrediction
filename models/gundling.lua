...
local function addconv(nin, nout, kw, kh, sw, sh, pw, ph)
  ...
  cnn:add(addconv(3,32,3,3,1,1,1,1))
  cnn:add(nn.Dropout(0.25))
  cnn:add(nn.SpatialMaxPooling( 2, 2, 2, 2))
  cnn:add(addconv(32,64,3,3,1,1,1,1))
  cnn:add(nn.Dropout(0.25))
  cnn:add(nn.SpatialMaxPooling( 2, 2, 2, 2))
  cnn:add(addconv(64,128,3,3,1,1,1,1))
  cnn:add(nn.Dropout(0.5))
  --[[cnn:add(nn.SpatialMaxPooling( 2, 2, 2, 2))
  cnn:add(addconv(128,256,3,3,1,1,1,1))
  cnn:add(nn.Dropout(0.4))
  cnn:add(nn.SpatialMaxPooling( 2, 2, 2, 2))
  cnn:add(addconv(256,512,3,3,1,1,1,1))
  cnn:add(nn.Dropout(0.4))
  cnn:add(nn.SpatialMaxPooling( 2, 2, 2, 2))-]]
  cnn:add(nn.View(128*32*32):setNumInputDims(3))
  --cnn:add(nn.Dropout(0.5))
  cnn:add(nn.Linear(128*32*32, 1024))
  cnn:add(nn.ReLU())
  cnn:add(nn.Dropout(0.5))
  cnn:add(nn.Linear(1024,1))
